    ...
    return (
        <div className="flex flex-col gap-20 items-center text-center justify-center">
            <div className="flex flex-col items-center text-center gap-6">
                <h1 className="text-[2.5rem] sm:text-[4rem] leano font-righteous font-semibold tracking-normal">Why Participate In <span className="text-[#004aac] drop-shadow-[0_0_15px_#004aac]">SuperNova</span></h1>
