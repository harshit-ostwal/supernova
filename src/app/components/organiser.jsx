    ...
    return (
        <div className="flex flex-col items-center mx-auto gap-20">
            <div className="flex flex-col items-center gap-6 text-center">
                <h1 className="text-[2.5rem] sm:text-[4rem] font-righteous font-semibold tracking-normal">Organizer <span className="text-[#004aac] drop-shadow-[0_0_15px_#004aac]">Lead</span></h1>
